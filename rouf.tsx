        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center">
          ...
          <div className="relative z-10 bg-white flex flex-col justify-center w-[509px] h-[300px] px-6 rounded-2xl shadow-lg">
            ...
            <div className="space-y-1 pb-4">
              ...
              <p>You Can Create Up to {maxOrders} orders for your first 1 selected client using your current credit limit of Rs {currentLimit}</p>
              ...
              try {
                ...
                if (totalOrderPrice > creditLimit) {
                  ...
                  if (maxOrders <= 0) {
                    ...
                    setIsCreditLimitExceeded(!isCreditLimitExceeded)
                    actions.setSubmitting(false);
                    return;
                  }
                  ...
                  setIsMoveOrdersToPending(!isMoveOrdersToPending)
                  setIsMoveToPending(true);
                  if (!isMoveToPending) {
                    actions.setSubmitting(false);
                    return;
