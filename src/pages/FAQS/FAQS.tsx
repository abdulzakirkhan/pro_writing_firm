...
import { useGetFaqCategoryQuery, useGetFaqQuestionsQuery } from "../../redux/faqApi/faqApi";

export default function FAQS() {
  const { data: getFaqCategories = [], isLoading: getFaqCategoryLoading } = useGetFaqCategoryQuery();
  const [activeTab, setActiveTab] = useState("");
  const [categoryId, setCategoryId] = useState<number | null>(null);

  const { data: getFaqQuestions, isLoading: getFaqQuestionLoading } = useGetFaqQuestionsQuery(categoryId, {
    skip: !categoryId,
  });
